...
export default function RegisterPage() {
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-4 py-12">
      <h1 className="font-display text-3xl font-extrabold text-navy">Join Snapperhouse</h1>
      <p className="mt-2 text-muted">
        Email confirmation required before authenticated actions. Suburb is needed before your
        first inquiry.
      </p>
