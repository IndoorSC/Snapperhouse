...
const SEEDS: Seed[] = [
  ...
  // Tetras — base catalogue expanded from Wikipedia “Tetra” species list
  // (duplicate common names for one species collapsed into aliases)
  { common: "Adonis Tetra", scientific: "Lepidarchus adonis", groupId: "g-tetras", genus: "Lepidarchus", aliases: ["Jellybean Tetra"], minTankLitres: 40 },
  { common: "African Longfin Tetra", scientific: "Brycinus longipinnis", groupId: "g-tetras", genus: "Brycinus", aliases: ["Longfin Tetra", "African Long-finned Tetra"], minTankLitres: 120 },
  { common: "African Moon Tetra", scientific: "Bathyaethiops caudomaculatus", groupId: "g-tetras", genus: "Bathyaethiops", minTankLitres: 80 },
  { common: "Arnold's Tetra", scientific: "Arnoldichthys spilopterus", groupId: "g-tetras", genus: "Arnoldichthys", aliases: ["Niger Tetra"], minTankLitres: 120 },
  { common: "Banded Tetra", scientific: "Psalidodon fasciatus", groupId: "g-tetras", genus: "Psalidodon", minTankLitres: 80 },
  { common: "Bandtail Tetra", scientific: "Moenkhausia dichroura", groupId: "g-tetras", genus: "Moenkhausia", aliases: ["Spottail Tetra"], minTankLitres: 80 },
  { common: "Barred Glass Tetra", scientific: "Phenagoniates macrolepis", groupId: "g-tetras", genus: "Phenagoniates", minTankLitres: 60 },
  { common: "Beacon Tetra", scientific: "Hemigrammus ocellifer", groupId: "g-tetras", genus: "Hemigrammus", aliases: ["Head and Taillight Tetra", "Head & Taillight Tetra"], minTankLitres: 60 },
  { common: "Belgian Flag Tetra", scientific: "Hyphessobrycon heterorhabdus", groupId: "g-tetras", genus: "Hyphessobrycon", aliases: ["Flag Tetra"], minTankLitres: 60 },
  { common: "Black Morpho Tetra", scientific: "Poecilocharax weitzmani", groupId: "g-tetras", genus: "Poecilocharax", minTankLitres: 50 },
  { common: "Black Neon Tetra", scientific: "Hyphessobrycon herbertaxelrodi", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 60 },
  { common: "Black Phantom Tetra", scientific: "Hyphessobrycon megalopterus", groupId: "g-tetras", genus: "Hyphessobrycon", aliases: ["Phantom Tetra"], minTankLitres: 60 },
  { common: "Black Tetra", scientific: "Gymnocorymbus ternetzi", groupId: "g-tetras", genus: "Gymnocorymbus", aliases: ["Butterfly Tetra", "Petticoat Tetra", "Black Widow Tetra"], minTankLitres: 60 },
  { common: "False Black Tetra", scientific: "Gymnocorymbus thayeri", groupId: "g-tetras", genus: "Gymnocorymbus", aliases: ["Silver Tetra Thayeri"], minTankLitres: 60 },
  { common: "Pretty Tetra", scientific: "Hemigrammus pulcher", groupId: "g-tetras", genus: "Hemigrammus", aliases: ["Black Wedge Tetra", "Garnet Tetra"], minTankLitres: 60 },
  { common: "Blackband Tetra", scientific: "Hyphessobrycon scholzei", groupId: "g-tetras", genus: "Hyphessobrycon", aliases: ["Blackline Tetra"], minTankLitres: 60 },
  { common: "Blackedge Tetra", scientific: "Tyttocharax madeirae", groupId: "g-tetras", genus: "Tyttocharax", aliases: ["Blue Tetra Madeirae"], minTankLitres: 40 },
  { common: "Rosy Tetra", scientific: "Hyphessobrycon rosaceus", groupId: "g-tetras", genus: "Hyphessobrycon", aliases: ["Black-flag Tetra"], minTankLitres: 60 },
  { common: "Black-jacket Tetra", scientific: "Moenkhausia takasei", groupId: "g-tetras", genus: "Moenkhausia", minTankLitres: 60 },
  ...
  { common: "Blind Tetra", scientific: "Stygichthys typhlops", groupId: "g-tetras", genus: "Stygichthys", minTankLitres: 60 },
  { common: "Blood Red Tetra", scientific: "Brittanichthys axelrodi", groupId: "g-tetras", genus: "Brittanichthys", minTankLitres: 50 },
  { common: "Bloodfin Tetra", scientific: "Aphyocharax anisitsi", groupId: "g-tetras", genus: "Aphyocharax", minTankLitres: 60 },
  { common: "Blueberry Tetra", scientific: "Hyphessobrycon wadai", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 60 },
  { common: "Blue Tetra", scientific: "Boehlkea fredcochui", groupId: "g-tetras", genus: "Boehlkea", aliases: ["Cochu Blue Tetra Boehlkea"], minTankLitres: 60 },
  { common: "Croaking Tetra", scientific: "Mimagoniates microlepis", groupId: "g-tetras", genus: "Mimagoniates", aliases: ["Blue Tetra Mimagoniates"], minTankLitres: 60 },
  { common: "Croaking Tetra Inequalis", scientific: "Mimagoniates inequalis", groupId: "g-tetras", genus: "Mimagoniates", minTankLitres: 60 },
  { common: "Croaking Tetra Lateralis", scientific: "Mimagoniates lateralis", groupId: "g-tetras", genus: "Mimagoniates", minTankLitres: 60 },
  { common: "Bucktooth Tetra", scientific: "Exodon paradoxus", groupId: "g-tetras", genus: "Exodon", minTankLitres: 120 },
  { common: "Buenos Aires Tetra", scientific: "Psalidodon anisitsi", groupId: "g-tetras", genus: "Psalidodon", aliases: ["Hyphessobrycon anisitsi"], minTankLitres: 80 },
  { common: "Serpae Tetra", scientific: "Hyphessobrycon eques", groupId: "g-tetras", genus: "Hyphessobrycon", aliases: ["Jewel Tetra", "Callistus Tetra"], minTankLitres: 60 },
  { common: "Calypso Tetra", scientific: "Hyphessobrycon axelrodi", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 50 },
  { common: "Candy Cane Tetra", scientific: "Hyphessobrycon sp. HY511", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 60 },
  ...
  { common: "Carlana Tetra", scientific: "Carlana eigenmanni", groupId: "g-tetras", genus: "Carlana", minTankLitres: 80 },
  { common: "Cochu's Blue Tetra", scientific: "Knodus borki", groupId: "g-tetras", genus: "Knodus", minTankLitres: 60 },
  { common: "Colombian Tetra", scientific: "Hyphessobrycon columbianus", groupId: "g-tetras", genus: "Hyphessobrycon", aliases: ["Colombia Tetra"], minTankLitres: 80 },
  { common: "Central Tetra", scientific: "Astyanax aeneus", groupId: "g-tetras", genus: "Astyanax", minTankLitres: 80 },
  { common: "Coffee-bean Tetra", scientific: "Hyphessobrycon takasei", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 50 },
  { common: "Colcibolca Tetra", scientific: "Astyanax nasutus", groupId: "g-tetras", genus: "Astyanax", minTankLitres: 80 },
  { common: "Congo Tetra", scientific: "Phenacogrammus interruptus", groupId: "g-tetras", genus: "Phenacogrammus", minTankLitres: 150 },
  { common: "Copper Tetra", scientific: "Hasemania melanura", groupId: "g-tetras", genus: "Hasemania", aliases: ["Silvertip Tetra Melanura"], minTankLitres: 50 },
  { common: "Costello Tetra", scientific: "Hemigrammus hyanuary", groupId: "g-tetras", genus: "Hemigrammus", aliases: ["January Tetra"], minTankLitres: 60 },
  { common: "Creek Tetra Scleroparius", scientific: "Bryconamericus scleroparius", groupId: "g-tetras", genus: "Bryconamericus", minTankLitres: 80 },
  { common: "Creek Tetra Terrabensis", scientific: "Bryconamericus terrabensis", groupId: "g-tetras", genus: "Bryconamericus", minTankLitres: 80 },
  { common: "Dawn Tetra", scientific: "Aphyocharax paraguayensis", groupId: "g-tetras", genus: "Aphyocharax", aliases: ["White Spot Tetra"], minTankLitres: 60 },
  { common: "Dawn Tetra Eos", scientific: "Hyphessobrycon eos", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 50 },
  { common: "Diamond Tetra", scientific: "Moenkhausia pittieri", groupId: "g-tetras", genus: "Moenkhausia", aliases: ["Pittier's Tetra"], minTankLitres: 80 },
  { common: "Discus Tetra", scientific: "Brachychalcinus orbicularis", groupId: "g-tetras", genus: "Brachychalcinus", minTankLitres: 100 },
  { common: "Dragonfin Tetra", scientific: "Pseudocorynopoma doriae", groupId: "g-tetras", genus: "Pseudocorynopoma", minTankLitres: 80 },
  { common: "Ember Tetra", scientific: "Hyphessobrycon amandae", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 40 },
  { common: "Emperor Tetra", scientific: "Nematobrycon palmeri", groupId: "g-tetras", genus: "Nematobrycon", aliases: ["Rainbow Tetra Palmeri"], minTankLitres: 60 },
  { common: "Rainbow Emperor Tetra", scientific: "Nematobrycon lacortei", groupId: "g-tetras", genus: "Nematobrycon", aliases: ["Rainbow Tetra"], minTankLitres: 60 },
  { common: "False Rummy-nose Tetra", scientific: "Petitella georgiae", groupId: "g-tetras", genus: "Petitella", minTankLitres: 80 },
  { common: "Featherfin Tetra", scientific: "Hemigrammus unilineatus", groupId: "g-tetras", genus: "Hemigrammus", aliases: ["One-line Tetra"], minTankLitres: 60 },
  { common: "Firehead Tetra", scientific: "Petitella bleheri", groupId: "g-tetras", genus: "Petitella", aliases: ["Brilliant Rummy-nose Tetra", "Bleher's Rummy-nose"], minTankLitres: 80 },
  { common: "Flame Tail Tetra", scientific: "Aphyocharax erythrurus", groupId: "g-tetras", genus: "Aphyocharax", minTankLitres: 60 },
  { common: "Flame Tetra", scientific: "Hyphessobrycon flammeus", groupId: "g-tetras", genus: "Hyphessobrycon", aliases: ["Von Rio Tetra", "Red Tetra", "Rio Tetra"], minTankLitres: 50 },
  { common: "Glass Tetra", scientific: "Moenkhausia oligolepis", groupId: "g-tetras", genus: "Moenkhausia", aliases: ["Glossy Tetra"], minTankLitres: 80 },
  { common: "Glass Bloodfin Tetra", scientific: "Prionobrama filigera", groupId: "g-tetras", genus: "Prionobrama", minTankLitres: 60 },
  { common: "Glowlight Tetra", scientific: "Hemigrammus erythrozonus", groupId: "g-tetras", genus: "Hemigrammus", minTankLitres: 60 },
  { common: "Gold Tetra", scientific: "Hemigrammus rodwayi", groupId: "g-tetras", genus: "Hemigrammus", aliases: ["Golden Tetra", "Brass Tetra"], minTankLitres: 60 },
  { common: "Goldencrown Tetra", scientific: "Aphyocharax alburnus", groupId: "g-tetras", genus: "Aphyocharax", minTankLitres: 60 },
  { common: "Griem's Tetra", scientific: "Hyphessobrycon griemi", groupId: "g-tetras", genus: "Hyphessobrycon", aliases: ["Goldspotted Tetra"], minTankLitres: 50 },
  { common: "Gold-tailed Tetra", scientific: "Carlastyanax aurocaudatus", groupId: "g-tetras", genus: "Carlastyanax", minTankLitres: 60 },
  { common: "Green Dwarf Tetra", scientific: "Odontocharacidium aphanes", groupId: "g-tetras", genus: "Odontocharacidium", minTankLitres: 40 },
  { common: "Green Neon Tetra", scientific: "Paracheirodon simulans", groupId: "g-tetras", genus: "Paracheirodon", minTankLitres: 60 },
  { common: "Hummingbird Tetra", scientific: "Trochilocharax ornatus", groupId: "g-tetras", genus: "Trochilocharax", minTankLitres: 40 },
  { common: "Jumping Tetra", scientific: "Hemibrycon tridens", groupId: "g-tetras", genus: "Hemibrycon", minTankLitres: 80 },
  { common: "Largespot Tetra", scientific: "Astyanax orthodus", groupId: "g-tetras", genus: "Astyanax", minTankLitres: 80 },
  { common: "Lemon Tetra", scientific: "Hyphessobrycon pulchripinnis", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 60 },
  { common: "Long-finned Glass Tetra", scientific: "Xenagoniates bondi", groupId: "g-tetras", genus: "Xenagoniates", minTankLitres: 60 },
  { common: "Longjaw Tetra", scientific: "Bramocharax bransfordii", groupId: "g-tetras", genus: "Bramocharax", minTankLitres: 100 },
  { common: "Loreto Tetra", scientific: "Hyphessobrycon loretoensis", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 60 },
  { common: "Mayan Tetra", scientific: "Hyphessobrycon compressus", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 60 },
  { common: "Mexican Tetra", scientific: "Astyanax mexicanus", groupId: "g-tetras", genus: "Astyanax", aliases: ["Blind Cave Tetra"], minTankLitres: 80 },
  { common: "Mimic Scale-eating Tetra", scientific: "Deuterodon heterostomus", groupId: "g-tetras", genus: "Deuterodon", minTankLitres: 80 },
  { common: "Mourning Tetra", scientific: "Brycon pesu", groupId: "g-tetras", genus: "Brycon", minTankLitres: 200 },
  { common: "Naked Tetra", scientific: "Gymnocharacinus bergii", groupId: "g-tetras", genus: "Gymnocharacinus", minTankLitres: 80 },
  { common: "Neon Tetra", scientific: "Paracheirodon innesi", groupId: "g-tetras", genus: "Paracheirodon", aliases: ["Neons"], minTankLitres: 60 },
  { common: "Nurse Tetra", scientific: "Brycinus nurse", groupId: "g-tetras", genus: "Brycinus", minTankLitres: 120 },
  { common: "Oneline African Tetra", scientific: "Nannaethiops unitaeniatus", groupId: "g-tetras", genus: "Nannaethiops", minTankLitres: 60 },
  { common: "Orangefin Tetra", scientific: "Bryconops affinis", groupId: "g-tetras", genus: "Bryconops", minTankLitres: 100 },
  { common: "Ornate Tetra", scientific: "Hyphessobrycon bentosi", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 60 },
  { common: "Panama Tetra", scientific: "Hyphessobrycon panamensis", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 60 },
  ...
  { common: "Peruvian Tetra", scientific: "Hyphessobrycon peruvianus", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 60 },
  { common: "Pristella Tetra", scientific: "Pristella maxillaris", groupId: "g-tetras", genus: "Pristella", aliases: ["X-Ray Tetra", "Xray Tetra"], minTankLitres: 50 },
  { common: "Pygmy Tetra", scientific: "Odontostilbe dialeptura", groupId: "g-tetras", genus: "Odontostilbe", minTankLitres: 40 },
  { common: "Red Eye Tetra", scientific: "Moenkhausia sanctaefilomenae", groupId: "g-tetras", genus: "Moenkhausia", aliases: ["Red-eye Tetra"], minTankLitres: 80 },
  { common: "Red Phantom Tetra", scientific: "Hyphessobrycon sweglesi", groupId: "g-tetras", genus: "Hyphessobrycon", aliases: ["Swegles's Tetra"], minTankLitres: 60 },
  { common: "Redspotted Tetra", scientific: "Copeina guttata", groupId: "g-tetras", genus: "Copeina", minTankLitres: 80 },
  { common: "Royal Tetra", scientific: "Inpaichthys kerri", groupId: "g-tetras", genus: "Inpaichthys", aliases: ["Kerri Tetra", "Blue Emperor Tetra"], minTankLitres: 60 },
  { common: "Ruby Tetra", scientific: "Axelrodia riesei", groupId: "g-tetras", genus: "Axelrodia", minTankLitres: 40 },
  { common: "Rummy-nose Tetra", scientific: "Petitella rhodostoma", groupId: "g-tetras", genus: "Petitella", aliases: ["Rummy Nose Tetra", "Hemigrammus rhodostomus"], minTankLitres: 80 },
  { common: "Sailfin Tetra", scientific: "Crenuchus spilurus", groupId: "g-tetras", genus: "Crenuchus", minTankLitres: 60 },
  { common: "Savage Tetra", scientific: "Hyphessobrycon savagei", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 60 },
  { common: "Savanna Tetra", scientific: "Hyphessobrycon stegemanni", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 50 },
  { common: "Semaphore Tetra", scientific: "Pterobrycon myrnae", groupId: "g-tetras", genus: "Pterobrycon", minTankLitres: 60 },
  { common: "Sharptooth Tetra", scientific: "Micralestes acutidens", groupId: "g-tetras", genus: "Micralestes", aliases: ["Silver Tetra Acutidens"], minTankLitres: 80 },
  { common: "Silver Tetra", scientific: "Ctenobrycon spilurus", groupId: "g-tetras", genus: "Ctenobrycon", minTankLitres: 100 },
  { common: "Silvertip Tetra", scientific: "Hasemania nana", groupId: "g-tetras", genus: "Hasemania", aliases: ["Silver Tip Tetra"], minTankLitres: 50 },
  { common: "Splash Tetra", scientific: "Copella arnoldi", groupId: "g-tetras", genus: "Copella", minTankLitres: 60 },
  { common: "Spotfin Tetra", scientific: "Hyphessobrycon socolofi", groupId: "g-tetras", genus: "Hyphessobrycon", aliases: ["Spot-fin Tetra"], minTankLitres: 60 },
  { common: "Spotted Tetra", scientific: "Copella nattereri", groupId: "g-tetras", genus: "Copella", minTankLitres: 60 },
  { common: "Tailspot Tetra", scientific: "Bryconops caudomaculatus", groupId: "g-tetras", genus: "Bryconops", minTankLitres: 100 },
  { common: "Three-lined African Tetra", scientific: "Neolebias trilineatus", groupId: "g-tetras", genus: "Neolebias", minTankLitres: 50 },
  { common: "Tiete Tetra", scientific: "Brycon insignis", groupId: "g-tetras", genus: "Brycon", aliases: ["Tietê Tetra"], minTankLitres: 200 },
  { common: "Tortuguero Tetra", scientific: "Hyphessobrycon tortuguerae", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 60 },
  { common: "Transparent Tetra", scientific: "Charax gibbosus", groupId: "g-tetras", genus: "Charax", minTankLitres: 100 },
  { common: "Big-scale African Tetra", scientific: "Brycinus macrolepidotus", groupId: "g-tetras", genus: "Brycinus", aliases: ["True Big-scale Tetra"], minTankLitres: 150 },
  { common: "Uruguay Tetra", scientific: "Cheirodon interruptus", groupId: "g-tetras", genus: "Cheirodon", minTankLitres: 50 },
  { common: "Yellow Tetra", scientific: "Hyphessobrycon bifasciatus", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 60 },
  { common: "Yellow-tailed African Tetra", scientific: "Alestopetersius caudalis", groupId: "g-tetras", genus: "Alestopetersius", minTankLitres: 80 },
  // Trade morphs / forms still listed under tetras
  { common: "Maylandia Tetra", scientific: "Hyphessobrycon sp.", groupId: "g-tetras", genus: "Hyphessobrycon", minTankLitres: 60 },
  { common: "Diamond Head Neon", scientific: "Paracheirodon innesi", groupId: "g-tetras", genus: "Paracheirodon", aliases: ["Diamond Neon"], minTankLitres: 60 },
